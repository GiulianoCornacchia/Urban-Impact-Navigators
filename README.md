...
To install SUMO on Linux it is necessary to execute the following commands:
...
You can install and update Homebrew as follows:
...
#### > Windows
1. In the Windows search box search for "Edit the system environment variables" option and open it;
